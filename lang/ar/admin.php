...
return [
    ...
    'users' => [
        ...
        'reason' => 'السبب',
        'reason_placeholder' => 'أضف سببًا لهذا التغيير في الوصول',
        'reason_required' => 'يجب إدخال سبب عند تعليق الحساب أو تعطيله.',
        'permanently_disabled_note' => 'لا يمكن إعادة تفعيل الحسابات المعطلة نهائيًا.',
        'saving' => 'جارٍ الحفظ...',
        ...
        'status_permanently_disabled' => 'معطّل نهائيًا',
        'provider_verification_details' => 'تفاصيل التحقق من مزود الخدمة',
    ...
    'hosts' => [
        ...
        'no_hosts_found' => 'لم يتم العثور على مضيفين',
        'view_host' => 'عرض المضيف',
        'edit_host' => 'تعديل المضيف',
        'delete_confirm' => 'هل أنت متأكد من حذف هذا المضيف؟',
        'item_name' => 'المضيف',
        'back_to_hosts' => 'العودة إلى المضيفين',
    ],
    'properties' => [
        'title' => 'العقارات',
    ...
    'bookings' => [
        ...
        'add_booking_information' => 'معلومات إضافة الحجز',
    ...
    'settings' => [
        ...
        'timezone_eastern' => 'التوقيت الشرقي (ET)', 'timezone_central' => 'التوقيت المركزي (CT)', 'timezone_mountain' => 'توقيت الجبال (MT)', 'timezone_pacific' => 'توقيت المحيط الهادئ (PT)', 'timezone_pakistan' => 'التوقيت الباكستاني (PKT)',
