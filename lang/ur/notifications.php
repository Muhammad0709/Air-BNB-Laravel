...
return [
    'title' => 'اطلاعات',
    'subtitle' => 'اپنی بکنگز اور اکاؤنٹ کی سرگرمی سے باخبر رہیں',
    'empty_title' => 'ابھی کوئی اطلاع نہیں',
    'empty_sub' => 'آپ کی بکنگز اور اکاؤنٹ سے متعلق اپڈیٹس یہاں نظر آئیں گی۔',
    'mark_read' => 'پڑھی گئی کے طور پر نشان زد کریں',
    'unread' => 'غیر پڑھی گئی',
    'see_all' => 'تمام اطلاعات دیکھیں',
    'marked_read' => 'اطلاع پڑھی گئی کے طور پر نشان زد ہو گئی',
    'all_marked_read' => 'تمام اطلاعات پڑھی گئی کے طور پر نشان زد ہو گئیں',
    'mark_failed' => 'اطلاعات کو نشان زد کرنے میں ناکامی',
