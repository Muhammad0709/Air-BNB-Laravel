...
return [
    ...
    'signin' => [
        ...
        'apple_intent_title' => 'Apple کے ساتھ جاری رکھیں',
        'google_intent_subtitle' => 'گوگل لاگ ان کے لیے کسٹمر، میزبان یا کمپنی منتخب کریں۔',
        'apple_intent_subtitle' => 'Apple لاگ ان کے لیے کسٹمر، میزبان یا کمپنی منتخب کریں۔',
    ...
    'signup' => [
        ...
        'company_registration_number_placeholder' => 'رجسٹریشن نمبر درج کریں',
        'company_registered_address' => 'رجسٹرڈ پتہ',
        'company_registered_address_placeholder' => 'رجسٹرڈ پتہ درج کریں',
        'company_contact_person' => 'رابطہ شخص',
        'company_contact_person_placeholder' => 'رابطہ شخص درج کریں',
        'company_description' => 'کمپنی کی تفصیل',
        'company_description_placeholder' => 'اپنی کمپنی کی تفصیل لکھیں',
        ...
        'sign_up_apple' => 'Apple کے ساتھ سائن اپ',
        'apple_intent_title' => 'Apple کے ساتھ جاری رکھیں',
        'apple_intent_subtitle' => 'Apple کے ساتھ سائن اپ کرنے کے لیے اپنا کردار منتخب کریں۔',
        'have_account' => 'پہلے سے اکاؤنٹ ہے؟',
        'log_in_link' => 'لاگ ان',
    ],
    'admin_login' => [
        'title' => 'ایڈمن لاگ ان',
        'heading' => 'ایڈمن لاگ ان',
