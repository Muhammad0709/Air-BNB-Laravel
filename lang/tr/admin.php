...
return [
    ...
    'dashboard' => [
        ...
        'pending_bookings' => 'Bekleyen Rezervasyonlar',
        'active_hosts' => 'Aktif Ev Sahipleri',
    ...
    'users' => [
        ...
        'reason' => 'Neden',
        'reason_placeholder' => 'Bu erişim değişikliği için bir neden ekleyin',
        'reason_required' => 'Bir hesabı askıya alırken veya devre dışı bırakırken neden gereklidir.',
        'permanently_disabled_note' => 'Kalıcı olarak devre dışı bırakılan hesaplar yeniden etkinleştirilemez.',
        'saving' => 'Kaydediliyor...',
        ...
        'status_permanently_disabled' => 'Kalıcı olarak devre dışı',
        'provider_verification_details' => 'Sağlayıcı doğrulama bilgileri',
    ...
    'hosts' => [
        'title' => 'Ev Sahipleri',
        'all_hosts' => 'Tüm Ev Sahipleri',
        'search_placeholder' => 'Ev sahiplerini ara...',
        'no_hosts_found' => 'Ev sahibi bulunamadı',
        'view_host' => 'Ev Sahibini Görüntüle',
        'edit_host' => 'Ev Sahibini Düzenle',
        'delete_confirm' => 'Bu ev sahibini silmek istediğinize emin misiniz?',
        'item_name' => 'ev sahibi',
        'back_to_hosts' => 'Ev Sahiplerine Dön',
    ],
    'properties' => [
        'title' => 'Mülkler',
    ...
    'bookings' => [
        ...
        'deleted_success' => 'Rezervasyon başarıyla silindi!',
        'add_booking_information' => 'Rezervasyon Ekleme Bilgileri',
    ...
    'settings' => [
        ...
        'timezone_eastern' => 'Doğu Saati (ET)', 'timezone_central' => 'Merkez Saati (CT)', 'timezone_mountain' => 'Dağ Saati (MT)', 'timezone_pacific' => 'Pasifik Saati (PT)', 'timezone_pakistan' => 'Pakistan Standart Saati (PKT)',
    ...
    'audit_logs' => [
        ...
        'all_logs' => 'Denetim Kayıtları',
        'subtitle' => 'Yöneticiler tarafından yapılan denetim işlemlerinin kaydı — onaylar, reddler ve silmeler.',
        'date' => 'Tarih',
        'admin' => 'Yönetici',
        'action' => 'İşlem',
        'subject' => 'Konu',
        'details' => 'Detaylar',
        'no_logs_found' => 'Henüz denetim kaydı yok.',
        'action_property_approved' => 'İlan onaylandı',
        'action_property_rejected' => 'İlan reddedildi',
        'action_review_deleted' => 'Değerlendirme silindi',
        'action_user_deleted' => 'Kullanıcı silindi',
    ],
];
