...
return [
    ...
    'subtitle' => 'ئاگاداری مانەوە و چالاکی هەژمارەکەت بە',
    'empty_title' => 'هێشتا ئاگادارکردنەوە نییە',
    'empty_sub' => 'نوێترین زانیاری دەربارەی مانەوە و هەژمارەکەت لێرە دەردەکەوێت.',
    'mark_read' => 'نیشانکردن وەک خوێندراوە',
    'unread' => 'نەخوێندراوە',
    'see_all' => 'هەموو ئاگادارکردنەوەکان ببینە',
    'marked_read' => 'ئاگادارکردنەوە وەک خوێندراوە نیشانکرا',
    'all_marked_read' => 'هەموو ئاگادارکردنەوەکان وەک خوێندراوە نیشانکران',
    'mark_failed' => 'نیشانکردنی ئاگادارکردنەوەکان سەرکەوتوو نەبوو',
