...
class StoreHostPropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'check_out_date' => ['nullable', 'required_unless:listing_category,experience', 'date_format:Y-m-d', 'after:check_in_date'],
    ...
    public function messages(): array
    {
        return [
            ...
            'images.required' => __('validation.property.images_required'),
