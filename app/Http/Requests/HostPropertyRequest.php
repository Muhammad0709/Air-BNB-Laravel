    ...
    public function rules(): array
    {
        ...
        if ($this->isMethod('POST')) {
            return [
                ...
                'maximum_stay' => 'required|integer|min:1|max:365|gte:minimum_stay',
        ...
        if ($this->isMethod('PUT') || $this->isMethod('PATCH')) {
            return [
                ...
                'house_rules' => 'sometimes|required|string|max:5000',
                'check_in_time' => 'sometimes|required|date_format:H:i',
                'check_out_time' => 'sometimes|required|date_format:H:i',
                'minimum_stay' => 'sometimes|required|integer|min:1|max:365',
                'maximum_stay' => 'sometimes|required|integer|min:1|max:365|gte:minimum_stay',
