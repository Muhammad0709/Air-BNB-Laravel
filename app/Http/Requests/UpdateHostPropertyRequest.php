...
class UpdateHostPropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'beds' => $this->isExperienceListing() ? ['nullable', 'integer', 'min:1'] : ['required', 'integer', 'min:1'],
            ...
            'minimum_stay' => $this->isExperienceListing() ? ['nullable', 'integer', 'min:1', 'max:365'] : ['required', 'integer', 'min:1', 'max:365'],
            'maximum_stay' => $this->isExperienceListing() ? ['nullable', 'integer', 'min:1', 'max:365'] : ['required', 'integer', 'min:1', 'max:365', 'gte:minimum_stay'],
