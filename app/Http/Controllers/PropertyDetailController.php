...
class PropertyDetailController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $propertyData = [
            ...
            'pickup_start_time' => $property->pickup_start_time ? \Carbon\Carbon::parse($property->pickup_start_time)->format('H:i') : null,
            'pickup_end_time' => $property->pickup_end_time ? \Carbon\Carbon::parse($property->pickup_end_time)->format('H:i') : null,
            'airport_pickup_price' => $property->airport_pickup_price !== null ? (float) $property->airport_pickup_price : null,
            ...
            'guided_tours_price' => $property->guided_tours_price !== null ? (float) $property->guided_tours_price : null,
            'host' => [
                'id' => $property->user->id,
