...
/** Guest reset-password (flexy-style: NewPasswordController + POST password.store). */
            ...
            <Box sx={{ maxWidth: 1160, width: '100%', mx: 'auto', px: { xs: 2, md: 3 }, py: { xs: 4, md: 6 } }}>
              <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <Box>
                  ...
                  <Typography variant="h4" fontWeight={700} sx={{ mb: 2, fontSize: { xs: 28, sm: 32, md: 36 }, lineHeight: 1.15 }}>{t('auth.reset_password_page.heading')}</Typography>
                  <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>{t('auth.reset_password_page.subtitle')}</Typography>
                      ...
                      <Stack spacing={2.5}>
                        ...
                        <Box>
                          ...
                          <TextField
                            ...
                            placeholder={t('auth.reset_password_page.password_placeholder')}
                            sx={fieldSx(formWidth)}
                            InputProps={{
                              endAdornment: (
                        ...
                        <Box>
                          ...
                          />
                          <InputError message={line(errors.password_confirmation)} />
                        </Box>
                        <Button type="submit" variant="contained" size="large" disabled={processing} sx={{ width: { xs: '100%', md: formWidth }, height: 52, borderRadius: 999, textTransform: 'none', fontWeight: 700, fontSize: 16, bgcolor: '#AD542D', boxShadow: 'none', '&:hover': { bgcolor: '#78381C', boxShadow: 'none' } }}>{processing ? t('auth.reset_password_page.submitting') : t('auth.reset_password_page.submit')}</Button>
                      </Stack>
                    </form>
                  </Paper>
                  <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', mt: 4 }}>
                    <MUILink component={Link} href="/login" underline="none" sx={{ color: '#AD542D', fontWeight: 600 }}>{t('auth.reset_password_page.back_to_login')}</MUILink>
                  </Typography>
                </Box>
              </Box>
            </Box>
