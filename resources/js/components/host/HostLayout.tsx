...
import HostNotificationDropdown from '../host/HostNotificationDropdown'
          ...
          <RBContainer fluid>
            <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ py: 2 }}>
              <Stack direction="row" alignItems="center" spacing={2} useFlexGap>
                ...
                <Typography variant="h6" sx={{ fontWeight: 700, color: '#222222', display: { xs: 'none', md: 'block' } }}>
                  {title}
                </Typography>
              </Stack>
                ...
                >
                  <Avatar
                    ...
                    sx={{
                      ...
                      fontWeight: 700,
                      color: '#FFFFFF',
                      ...(hostUser.profile_picture ? {} : { border: '2px solid rgba(173, 84, 45, 0.2)' }),
              ...
              >
                <Box sx={{ py: 1 }}>
                  <MenuItem onClick={handleSettingsClick} sx={{ py: 1.5, px: 2, mx: 1, borderRadius: 1, '&:hover': { bgcolor: '#F9FAFB' } }}>
                    ...
                    <Typography sx={{ fontSize: 14, color: '#222222', fontWeight: 500 }}>{t('host.settings.title')}</Typography>
                  </MenuItem>
                  ...
                  <MenuItem onClick={handleLogoutClick} sx={{ py: 1.5, px: 2, mx: 1, borderRadius: 1, '&:hover': { bgcolor: '#F9FAFB' } }}>
                    ...
                    <Typography sx={{ fontSize: 14, color: '#222222', fontWeight: 500 }}>{t('host.settings.log_out')}</Typography>
                  </MenuItem>
                </Box>
              </Menu>
            </Stack>
