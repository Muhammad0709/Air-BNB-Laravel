...
export default function NotificationDropdown() {
    ...
    const markAsRead = async (notificationId: number) => {
        try {
            router.patch(`/admin/notifications/${notificationId}/mark-as-read`, {}, {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
    ...
    const markAllAsRead = async () => {
        try {
            router.patch('/admin/notifications/mark-all-as-read', {}, {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
                    setNotifications(prev =>
    ...
    useEffect(() => {
        ...
        const channel = (window as any).Echo?.private('admin-notifications');
        if (channel) {
